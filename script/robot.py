...
Original source:
https://github.com/ryuichiueda/LNPR_BOOK_CODES/blob/master/scripts/robot.py

License:
This code is subject to the license of the original repository.
See: https://github.com/ryuichiueda/LNPR_BOOK_CODES/blob/master/LICENSE.md
"""
